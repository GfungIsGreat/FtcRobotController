package org.firstinspires.ftc.teamcode.Roadrunner_Sample;
...
public class    Hardware_v3 {
    ...
    /**
     * Init method. Call upon the initialisation of an OpMode. Maps hardware to its variables. Call
    ...
    /**
      * Reset method. Call after <code>init()</code>.
     */
    public void reset() {
     ...
     * @param position The target position, typically the backdrop's set line height. Integer value
     *                 from 0-2.
