...
@Config
@Disabled
@Autonomous(name = "auton_red_nearboard")
public class Auton_red_nearboard extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence left = drive.trajectorySequenceBuilder(new Pose2d(19.01, -63.45, Math.toRadians(90.00)))
                .lineToSplineHeading(new Pose2d(10.29, -31.54, Math.toRadians(360.00)))
                .addTemporalMarker(() -> {
                    robot.leftClawOpen();
                })
                .waitSeconds(1)
                ...
                */
                ...
                .lineToSplineHeading(new Pose2d(55.00, -31.00, Math.toRadians(0.00)))
                .addTemporalMarker(()->{
        ...
        TrajectorySequence middle = drive.trajectorySequenceBuilder(startPose)
                ...
                */
                ...
                .lineToSplineHeading(new Pose2d(55, -41.43, Math.toRadians(0)),SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
        ...
        TrajectorySequence right = drive.trajectorySequenceBuilder(new Pose2d(19.01, -63.45, Math.toRadians(90.00)))
                .splineTo(new Vector2d(35.25, -52.57), Math.toRadians(403.85))
                .lineToSplineHeading(new Pose2d(34.77, -34.00, Math.toRadians(360.00)))
                .addTemporalMarker(() -> {
                    robot.leftClawOpen();
                })
                .waitSeconds(1)
                ...
                */
                ...
                .lineToConstantHeading(new Vector2d(55, -47))
                .addTemporalMarker(()->{
                    scoringStage = scoring_stage.SET;
                })
                .build();
        ...
        while (opModeIsActive()){
            ...
            switch (cameraStage){
                ...
                case FINISH:
                    ...
                    if (cur > 1000) {
                        ...
                        robot.clawP.setPosition(0.5); // TODO: set claw orientation pos to scoring pos
            ...
            switch (scoringStage){
                case READY:
                    ...
                    if (completed){
                        cameraStage= camera_stage.PARKING;
                    }
                    break;
                case CLAMP:
                    robot.retractSlider();
                ...
                case SLIDERSUP:
                    if (cur>400){
                        robot.setArm(0); // TODO: set arm pos to scoring pos
                        robot.setSlider(robot.heightplaced); // TODO: set heighplaced value or slider pos
                    }
