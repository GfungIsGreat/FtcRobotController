...
public class Auton_red_NSHardware {
    ...
    public Auton_red_NSHardware(HardwareMap hardwareMap) {
        hwmap = hardwareMap;
    }
    ...
    public void init(HardwareMap hardwareMap) {
        ...
        webcam1.setPipeline(new redLeftPipeline());
    ...
    public class redLeftPipeline extends OpenCvPipeline {
        Mat HSV = new Mat();
        Mat leftCrop;
        Mat midCrop;
        Mat rightCrop;
