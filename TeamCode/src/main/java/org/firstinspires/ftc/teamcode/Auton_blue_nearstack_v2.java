...
@Config
@Autonomous(name = "auton_blue_nearstack_v2")
public class Auton_blue_nearstack_v2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence left = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToLinearHeading(new Pose2d(36.70, 34.77, Math.toRadians(0.00)),SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
        ...
        TrajectorySequence middle = drive.trajectorySequenceBuilder(startPose)
                .lineToSplineHeading(new Pose2d(-38.54, 18, Math.toRadians(270.00)), SampleMecanumDrive.getVelocityConstraint(25, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .waitSeconds(1)
                .splineTo(new Vector2d(-28.34, 11.40), Math.toRadians(0.00),SampleMecanumDrive.getVelocityConstraint(25, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .lineToConstantHeading(new Vector2d(36.70, 11.4))
                .lineToConstantHeading(new Vector2d(36.70, 34.77))
                .addTemporalMarker(()->{
                    scoringStage = scoring_stage.READY_SCORE;
                })
                .build();
        ...
        TrajectorySequence right = drive.trajectorySequenceBuilder(startPose)
                .splineToConstantHeading(new Vector2d(-47.85, 19.15), Math.toRadians(255.00))
                .waitSeconds(1)
