...
@Config
@Autonomous(name = "auton_blue_nearboard_v2")
public class Auton_blue_nearboard_v2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence right = drive.trajectorySequenceBuilder(startPose)
                .lineToSplineHeading(new Pose2d(10.29, 31.54, Math.toRadians(180)))
                .waitSeconds(1)
                .lineToLinearHeading(new Pose2d(36.70, 34.77, Math.toRadians(0.00)),SampleMecanumDrive.getVelocityConstraint(25, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
